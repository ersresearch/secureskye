...
/**
 * An event that reports the current wheel speed of the vehicle's individual wheels.
 *
 ...
 * @property frontLeft The front left wheel's speed.
 * @property frontRight The front right wheel's speed.
 * @property rearLeft The rear left wheel's speed.
 * @property rearRight The rear right wheel's speed.
 */
@Document(collection = "vehicles.events.wheelSpeed")
@CompoundIndexes(
