...
/**
 * An event that reports the current gear after the vehicle's gear was shifted.
 *
 ...
 * @property gear The current gear.
 */
@Document(collection = "vehicles.events.gearShift")
@CompoundIndexes(
