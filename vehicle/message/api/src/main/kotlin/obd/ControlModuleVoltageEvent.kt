...
/**
 * An event that reports the current voltage of the vehicle's control module.
 *
 ...
 * @property voltage The current voltage in Volt.
 */
@Document(collection = "vehicles.events.obd.controlModuleVoltage")
@CompoundIndexes(
...
data class ControlModuleVoltageEvent(
    @Id
