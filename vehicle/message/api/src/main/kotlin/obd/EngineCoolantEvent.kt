...
/**
 * An event that reports the current coolant temperature of the vehicle's engine.
 *
 ...
 */
@Document(collection = "vehicles.events.obd.engineCoolant")
@CompoundIndexes(
