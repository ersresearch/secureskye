...
/**
 * An event that reports the current VIN (Vehicle Identification Number) of the vehicle.
 *
 ...
 * @property value The current VIN.
 */
@Document(collection = "vehicles.events.obd.vin")
@CompoundIndexes(
