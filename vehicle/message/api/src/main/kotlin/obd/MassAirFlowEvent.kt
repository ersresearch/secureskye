...
/**
 * An event that reports the current mass air flow of the vehicle.
 *
 ...
 * @property rate The current mass air flow rate in grams/sec.
 */
@Document(collection = "vehicles.events.obd.massAirFlow")
@CompoundIndexes(
