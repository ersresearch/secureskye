...
/**
 * An event that reports the latest trouble code of the vehicle.
 *
 ...
 * @property code The latest trouble code.
 */
@Document(collection = "vehicles.events.obd.troubleCode")
@CompoundIndexes(
