...
/**
 * An event that reports the current ambient temperature of the vehicle.
 *
 ...
 */
@Document(collection = "vehicles.events.obd.ambientTemperature")
@CompoundIndexes(
...
data class AmbientTemperatureEvent(
    @Id
