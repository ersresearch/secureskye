...
/**
 * An event that reports the current runtime of the vehicle's engine.
 *
 ...
 * @property seconds The current running time in seconds.
 */
@Document(collection = "vehicles.events.obd.engineRuntime")
@CompoundIndexes(
