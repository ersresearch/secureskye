...
/**
 * An event that reports the current speed of the vehicle.
 *
 ...
 * @property kmh The current speed in kilometers per hour.
 */
@Document(collection = "vehicles.events.obd.speed")
@CompoundIndexes(
