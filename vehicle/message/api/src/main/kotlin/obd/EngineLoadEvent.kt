...
/**
 * An event that reports the current load of the vehicle's engine.
 *
 ...
 * @property value The current load as percentage.
 */
@Document(collection = "vehicles.events.obd.engineLoad")
@CompoundIndexes(
