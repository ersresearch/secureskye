...
/**
 * An event that reports the current fuel level of the vehicle.
 *
 ...
 * @property value The current fuel level as percentage.
 */
@Document(collection = "vehicles.events.obd.fuelLevel")
@CompoundIndexes(
