...
/**
 * An event that reports the current throttle of the vehicle.
 *
 ...
 * @property value The current throttle as percentage.
 */
@Document(collection = "vehicles.events.obd.throttle")
@CompoundIndexes(
