...
/**
 * An event that reports the current travelled distance since last code reset of the vehicle.
 *
 ...
 * @property value The current travelled distance in kilometers.
 */
@Document(collection = "vehicles.events.obd.codeClearDistance")
@CompoundIndexes(
...
data class CodeClearDistanceEvent(
    @Id
