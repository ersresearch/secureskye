...
/**
 * An event that reports the current fuel consumption of the vehicle's engine.
 *
 ...
 */
@Document(collection = "vehicles.events.fuelConsumption")
@CompoundIndexes(
...
data class FuelConsumptionEvent(
    @Id
